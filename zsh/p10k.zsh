...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # If local branch name is at most 60 characters long, show it in full.
      # Otherwise show the first 25 … the last 25.
      # Tip: To always show local branch name in full without truncation, delete the next line.
      (( $#branch > 60 )) && branch[26,-26]="…"  # <-- this line
    ...
    if [[ -n $VCS_STATUS_TAG
      ...
      # If tag name is at most 60 characters long, show it in full.
      # Otherwise show the first 25 … the last 25.
      # Tip: To always show tag name in full without truncation, delete the next line.
      (( $#tag > 60 )) && tag[26,-26]="…"  # <-- this line
      res+="${meta}#${clean}${tag//\%/%%}"
    fi
